...
<AccordionGroup>
 ...
 ## Step 1: Install Homebrew
    ...
    We use [GitHub](https://github.com/hoagieclub/) for version control. You will need to have [GitHub SSH keys](https://docs.github.com/en/github/authenticating-to-github/connecting-to-github-with-ssh) set up.
    ...
    **NOTE:** Environment variables are <b>not</b> included in cloned repositories.
    ...
    From each respository, run `yarn`:
    ```bash bash
    yarn
    ```
